...
function PageContent({ ready, configuration, username, avatar, intl }) {
  if (!ready) {
    return (
      <PageLoading
        srMessage={intl.formatMessage(messages['app.loading.message'])}
      />
    );
  }
  ...
  const userMenu = [
    ...
    },
    {
      ...
      content: intl.formatMessage(
        messages['siteheader.user.menu.account.settings'],
      ),
    },
    {
      type: 'item',
      ...
      content: intl.formatMessage(
        messages['siteheader.user.menu.order.history'],
      ),
    },
    {
      type: 'item',
