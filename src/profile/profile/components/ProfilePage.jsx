...
export class ProfilePage extends React.Component {
    ...
    return (
      <div className="row">
        <div className="col-md-4 col-lg-3">
          <StatusAlert
            alertType="danger"
            dialog={photoUploadError.userMessage}
            dismissible={false}
            open
          />
        </div>
  ...
  renderAgeMessage() {
    ...
    return (
      <AgeMessage
        accountSettingsUrl={this.props.configuration.ACCOUNT_SETTINGS_URL}
      />
    );
  }
  ...
  renderContent() {
    ...
    if (isLoadingProfile) {
      return (
        <PageLoading
          srMessage={this.props.intl.formatMessage(messages['profile.loading'])}
        />
      );
    }
      ...
      <div className="container-fluid">
        <div className="row align-items-center pt-4 mb-4 pt-md-0 mb-md-0">
          <div className="col-auto col-md-4 col-lg-3">
            <div className="d-flex align-items-center d-md-block">
              <ProfileAvatar
                ...
                isEditable={
                  this.props.isAuthenticatedUserProfile &&
                  !requiresParentalConsent
                }
              />
            </div>
          ...
          <div className="col pl-0">
            <div className="d-md-none">{this.renderHeadingLockup()}</div>
...
ProfilePage.propTypes = {
  ...
  courseCertificates: PropTypes.arrayOf(
    PropTypes.shape({
  ...
  languageProficiencies: PropTypes.arrayOf(
    PropTypes.shape({
  ...
  draftSocialLinksByPlatform: PropTypes.objectOf(
    PropTypes.shape({
      platform: PropTypes.string,
      socialLink: PropTypes.string,
    }),
